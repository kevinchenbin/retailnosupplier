...
void __fastcall TfrmQryProcureNote::eddanhaoChange(TObject *Sender)
{
	if (eddanhao->Text != "") {
...
void __fastcall TfrmQryProcureNote::SpeedButton1Click(TObject *Sender)
{
...
void __fastcall TfrmQryProcureNote::edpyqueryKeyPress(TObject *Sender, wchar_t &Key)
