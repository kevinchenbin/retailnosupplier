...
//---------------------------------------------------------------------------
void TfrmStockInQuery::Init(TApplication* app, TADOConnection* con)
{
...
//---------------------------------
String TfrmStockInQuery::QuerySum()
{
   String tmpsql="";
...
String TfrmStockInQuery::QueryCom()
{
	String tmpsql="";
...
void __fastcall TfrmStockInQuery::btnExit3Click(TObject *Sender)
{
