...
#ifndef StockInQueryaaH
#define StockInQueryaaH
//---------------------------------------------------------------------------
#include <Classes.hpp>
...
#include "GridsEh.hpp"
//---------------------------------------------------------------------------
class TfrmStockInQueryaa : public TfrmMDIChild
{
...
public:		// User declarations
	__fastcall TfrmStockInQueryaa(TComponent* Owner);
...
//---------------------------------------------------------------------------
extern PACKAGE TfrmStockInQueryaa *frmStockInQueryaa;
//---------------------------------------------------------------------------
#endif
