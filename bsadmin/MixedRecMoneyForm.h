...
__published:	// IDE-managed Components
	...
	TRzLabel *RzLabel6;
	TRzLabel *RzLabel7;
	TRzNumericEdit *zifubao;
	TRzNumericEdit *weixin;
	TLabel *Label2;
	TRzNumericEdit *ssje;
	...
	void __fastcall zifubaoKeyPress(TObject *Sender, wchar_t &Key);
	void __fastcall weixinKeyPress(TObject *Sender, wchar_t &Key);
...
public:		// User declarations
	...
	void GetRecMoney(float& card,float& cash,float& poscard,float& youhuiquan,float& wexi,float& m_zfb);
};
//---------------------------------------------------------------------------
