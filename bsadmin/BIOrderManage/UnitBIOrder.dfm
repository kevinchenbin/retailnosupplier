object frmBIorder: TfrmBIorder
  ...
  object RzToolbar1: TRzToolbar
    ...
    object BtnLastRecord: TRzToolButton
      ...
      UseToolbarVisualStyle = False
      VisualStyle = vsGradient
      Caption = #36890#30693#22238#21578
  ...
  object GroupBox2: TGroupBox
    ...
    object editdiscount: TEdit
      ...
      TabOrder = 2
      Text = '100'
      OnKeyPress = editdiscountKeyPress
    end
    object Edit1: TEdit
      Left = 824
      Top = -24
  ...
  object GroupBox1: TGroupBox
    ...
    object cbstate: TComboBox
      ...
      Items.Strings = (
        ...
        #20840#37096#25764#28040
        #24050#23457#26680
        #26410#23457#26680
        #24050#25552#20132#23458#25143#22238#21578)
    end
  ...
  object ImageList1: TImageList
    ...
    Top = 304
    Bitmap = {
      494C01012A004800B00110001000FFFFFFFFFF10FFFFFFFFFFFFFFFF424D3600
  ...
  object aqupdatehead: TADOQuery
    ...
    SQL.Strings = (
        ...
        'me as OpName from BS_OrderNoteHeader A'
  ...
  object aqorderdetail: TADOQuery
    CursorType = ctStatic
    LockType = ltBatchOptimistic
    BeforeScroll = aqorderdetailBeforeScroll
    Parameters = <
      item
        Name = 'ID'
        DataType = ftInteger
    ...
    SQL.Strings = (
        ...
        'select distinct RANK() OVER(order by A.ID desc) as xuhao, A.id, ' +
        'A.OrderNtHeaderID,B.ISBN,B.name as bookname,P.AbbreviatedName,B.' +
        'price,A.amount,A.Discount,A.localnum,A.xuxiao,A.class,A.newbook,'
      
        'A.fixedPrice,A.Discountedprice,A.bk , A.bkcatalogid,A.SendAmount' +
        ',A.UnSendAmount,case when A.state = 0 then '#39#26377#25928#39' else '#39#26080#25928#39' end as' +
        ' state1,B.PressCount,B.UserDefCode,B.Author,'
      
        'A.xiaoqu,A.xueyuan,A.course,A.incode,A.teacher,A.telphone,A.need' +
        'procurenum,dbo.UF_BS_GetAmountByCatalogid(A.bkcatalogid,BS_Order' +
        'NoteHeader.stgid) as stkamount,'
      
        'C.stkamount as bookamount,C.usableamount,case when A.needprocure' +
        'num = 10 then '#39#8730#39' else '#39#39' end as prostate '
      ' from BS_OrderNote A'
      
        'left join BS_OrderNoteHeader on A.orderNtHeaderID = BS_OrderNote' +
        'Header.id '
      'left join bs_bookcatalog B On A.bkcatalogID = B.ID'
      'left join bs_pressinfo P ON B.pressID = P.ID'
      
        'left join Order_lock C on A.bkcatalogID = C.BkcatalogID and BS_O' +
        'rderNoteHeader.stgid = C.stgid'
      'where A.orderNtHeaderID = :ID')
    Left = 416
    Top = 344
  end
  ...
  object aqhd: TADOQuery
    ...
    SQL.Strings = (
        ...
        'ID,U.name as OpName from BS_OrderNoteHeader A'
      'left join SYS_StorageInfo S ON A.stgID = S.ID'
      'left join SYS_User U ON A.operatorID = U.ID'
      'left join CUST_customerinfo C ON C.ID = A.vendorID '
  ...
  object pm1: TPopupMenu
    ...
    object N12: TMenuItem
      Caption = #30830#35748#26032#20070
      OnClick = N12Click
    end
  ...
  object querypress: TADOQuery
    ...
    SQL.Strings = (
      'select count(distinct C.AbbreviatedName) AS presscount'
      
        'FROM (select case when P.AbbreviatedName is null then '#39#39' else P.' +
        'AbbreviatedName end as AbbreviatedName from BS_OrderNote A'
      'left join bs_bookcatalog B On A.bkcatalogID = B.ID'
      'left join bs_pressinfo P ON B.pressID = P.ID'
      'where A.orderNtHeaderID = :ID) C'
      '')
    Left = 744
    Top = 192
  end
