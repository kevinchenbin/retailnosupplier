...
__published:	// IDE-managed Components
	...
	TCheckBox *huiyuancheck;
	TCheckBox *zdlingkoucheck;
	TRzNumericEdit *huiyuandiscount;
	TRzNumericEdit *lingkoudiscount;
	...
	void __fastcall huiyuandiscountChange(TObject *Sender);
	void __fastcall lingkoudiscountChange(TObject *Sender);
private:	// User declarations
	int m_amount;
	float m_discount,m_pixiaodiscount,m_lsdiscount,m_huiyuandis,m_lszddis;
	BSMode m_bsmode;
public:		// User declarations
	...
	bool Getlszddiscount(float&discount);
	bool Gethuiyuandiscount(float&discount);
	int salediscount;
	AnsiString text;
};
//---------------------------------------------------------------------------
